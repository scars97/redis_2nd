...
class SeatTest {
    ...
    fun isUnavailableSeatThenThrowException(): Collection<DynamicTest> {
        // given
        val statusIsReserved = Seat(1L, "A1", SeatStatus.RESERVED, 1L, 1L)
        val reservationIsNotNull = Seat(1L, "A1", SeatStatus.AVAILABLE, 1L, 1L)
    ...
    fun seatReserve() {
        ...
        //then
        assertThat(seat).extracting("status", "reservationId")
